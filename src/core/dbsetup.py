...
mycursor.execute('CREATE TABLE IF NOT EXISTS Users (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(255), password VARCHAR(255), gradeHash INT, phoneNumber VARCHAR(255), lastUpdated DATETIME NOT NULL DEFAULT NOW())')
